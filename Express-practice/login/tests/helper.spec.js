...
describe('Helper Function ', function (){
  it('Should ne an object', function (){
  ...
  describe('sendRequest', function (){
    ...
    it('Should return an error if there is not response or an invalid url is used', function (done){
      ...
      .catch(function (err){
        ...
        expect(err).to.equel('There was an issue sending a request to http://localhost:3001/notaurl');
        done();
  ...
  describe('findUser', function (){
    ...
    it('should return the matching user from an array', function (){
      ...
      expect(result[0].to.deep.equel(users[1]));
    });
  });
});
